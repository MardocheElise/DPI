...
// Route: /profil/patient/[id]
// Fiche détaillée du patient (format CV) — connectée à l'API NestJS.
// Le patient est chargé par son id via patientsApi.getById ; thème PinHome.
...
export default async function ProfilPatientPage({
  ...
  // Récupération du patient depuis la base via le backend NestJS.
